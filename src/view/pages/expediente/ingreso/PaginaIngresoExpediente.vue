      ...
      <v-stepper-items>
        <v-stepper-content step="1">
          ...
          >
            ...
            <v-card-text class="pl-2 pr-2 pt-2">
              <v-form
                ref="form"
                ...
                <v-row>
                  <v-col cols="12" md="12" class="pt-4 pb-0">
                    <v-text-field
                      ...
                      :rules="[
                        required('Monto de inversión del proyecto'),
                        decimals('Monto de inversión del proyecto')
                        ]"
                    ></v-text-field>
                  </v-col>
                </v-row>
            ...
            <v-card outlined class="mt-8">
              <v-card-text class="ml-1 mr-1">
                <v-row>
                  <v-col cols="12">
                    <v-subheader class="text-h6 text-uppercase">Equipo de trabajo</v-subheader>
                    <v-divider></v-divider>
                  </v-col>
                </v-row>
                  ...
                  <v-row >
                    <v-col cols="12" md="8" sm="12">
                      <v-text-field
                        ...
                        autocomplete="off"
                        dense
                        v-model="filtroConsultor"
                        label="Nit del consultor"
                      >  
                    ...
                    <v-col cols="12" md="4" sm="12">
                      <v-btn
                        color=""
                        dark
                        class="float-right blue-grey darken-2 mt-1"
                        @click="buscarConsultor"
                        :loading="btnBuscarConsultorLoading"
                      >
                  ...
                  <v-row v-if="consultorEncontrado != 0">

                        <v-col cols="12" class="pt-0 pb-0"  v-if="consultorEncontrado ===2">
                          <v-alert
                            dense
                            outlined
                            type="error"
                          >
                            No se ha encontrado el consultor con el nit especificado!
                          </v-alert>
                        </v-col>
                  </v-row>
                    <!-- inicio: datos consultor encontrado -->

                  <v-row v-if="consultorEncontrado ===1">
                    <v-col cols="12">
                      <v-alert
                          dense
                          outlined
                        ...
                        >
                           Se ha encontrado el consultor con el nit especificado
                        </v-alert>
                    </v-col>
                    ...
                    <v-col cols="12" md="4" sm="12" class="pt-0 pb-0"  >
                        <v-list-item two-line>
                            <v-list-item-content class="pb-0 pt-0">
                                <v-list-item-title class="text-h7">NIT</v-list-item-title>
                                <v-list-item-subtitle class="text-h7">{{datoConsultor.nit}}</v-list-item-subtitle>
                            </v-list-item-content>
                        </v-list-item>
                    </v-col>
                    ...
                    <v-col cols="12" md="4" sm="12" class="pt-0 pb-0" >
                        <v-list-item two-line>
                            <v-list-item-content class="pb-0 pt-0">
                                <v-list-item-title class="text-h7">Número Licencia</v-list-item-title>
                                <v-list-item-subtitle class="text-h7">{{datoConsultor.numero_Licencia}}</v-list-item-subtitle>
                            </v-list-item-content>
                        </v-list-item>
                    </v-col>
                    ...
                    <v-col cols="12" md="4" sm="12" class="pt-0 pb-0">
                        <v-list-item two-line>
                            <v-list-item-content class="pb-0 pt-0">
                                <v-list-item-title class="text-h7">Nombre de la empresa</v-list-item-title>
                                <v-list-item-subtitle class="text-h7">{{datoConsultor.nombre_Empresa_Profesional}}</v-list-item-subtitle>
                            </v-list-item-content>
                        </v-list-item>
                    </v-col>
                    <!--fin:: datos consultor encontrado -->
                    ...
                    <v-col cols="12">
                      <v-btn
                          ...
                          dark
                          class="float-right blue-grey darken-2 mt-1"
                          @click="asignarConsultor"
                          :loading="btnAsignarConsultorLoading"
                        >
                      

                          Asignar consultor al expediente
                        </v-btn>
                      
                    </v-col>

                  </v-row>
                  <v-row v-if="expedienteRegistrado===1">
        ...
        <v-stepper-content step="5">
          <v-card tile>
            <v-card-title>
              <v-subheader class="text-h6 text-uppercase">Requisitos</v-subheader>
              <v-spacer></v-spacer>
            </v-card-title>
              ...
              <v-row>
                ...
                <v-col cols="12" md="12" sm="12" class="pt-4">
                  <v-data-table
                    ...
                    :items="requisitosCargados"
                    :loading="tableLoadingRequisitos"
                    hide-default-footer
                    :footer-props="{
                      showFirstLastPage: true,
                      firstIcon: 'mdi-page-first',
                  ...
                  >
                      ...
                      <tr>
                        ...
                        <td>
                          <v-chip
                            ...
                            small
                          >
                            {{ item.cargado > 0  ? `Cargado` : `No cargado` }}
                          </v-chip>
                        </td>
                        <td>
                          <v-btn
                            ...
                            @click="
                              mostrarModalCargaDocumento(item.nombreDocumento, item.id, 1)
                            "
                          >
                    ...
                    <template v-slot:no-data>
                      <p class="text-h7">
                        <v-icon left>mdi-alert</v-icon> No existen requisitos ingresados
                      </p>
                    </template>
                  </v-data-table>
                </v-col>
...
import { OBTENER_CONSULTORES, BUSCAR_CONSULTOR } from "@/core/services/store/consultores/consultores.module";
...
import {REGISTAR_REQUISITO_EXPEDIENTE, OBTENER_REQUISITOS_EXPEDIENTE_BY_CATEGORIA_TIPOINSTRUMENTO} from "@/core/services/store/expedientes/requisitos/requisitoexpediente.module";
...
export default {
  ...
  data() {
    return {
      ...
      validFormDocumento: false,
      btnCargaDocLoading: false,
      e1: 1,
      ...
      btnBuscarConsultorLoading: false,
      btnAsignarConsultorLoading:false,
      filtroConsultor: "",
      datoConsultor:{},
      consultorEncontrado: 0,
      datosAsignacionConsultor: {
          id: 0,
          numero_Licencia: "",
          usuario_Creacion: "admin",
          fecha_Creacion: "",
      ...
      datosRequisitoExpediente: {
        id: 0,
        path: "",
        asigAcuerdoRequisitosId: 0,
        expedienteId: 0,
        usuario_Creacion: "admin",
        estadosId: 1
      },
  ...
  methods: {
    ...
    //Buscar consultor por nombre, nit, etc
    async buscarConsultor(){
      this.datoConsultor ={};
      this.consultorEncontrado=0;
      this.btnBuscarConsultorLoading=true;
      await this.$store
        .dispatch(BUSCAR_CONSULTOR, this.filtroConsultor)
        .then((res) => {
          if (res.status === 200) {
            this.datoConsultor = res.data;
            this.datosAsignacionConsultor = this.datoConsultor;
            this.datosAsignacionConsultor.expedienteId = this.id_expediente;
            this.consultorEncontrado=1;
            //console.log(this.categorias);
          } else {
            this.consultorEncontrado=2;
          }
          this.btnBuscarConsultorLoading=false;
        })
        .catch(() => {
          this.btnBuscarConsultorLoading=false;
        });
    ...
    async registrarItem() {
      ...
      if (this.id_expediente == 0) {
       // console.log("Guardar");
        this.accion = 1;
      } else {
        //console.log("Modificar");
        this.accion = 2;
        this.datosItem.id = this.id_expediente;
      }
      //console.log(this.datosItem);
      if (this.accion === 1) {
        await this.$store
          .dispatch(REGISTAR_EXPEDIENTE, this.datosItem)
          .then((res) => {
            //console.log(res);
            if (res.status === 200) {
              this.$refs.snackalert.SnackbarShow(
              ...
              // }
              this.id_expediente = res.data;
              this.datosItem.id = this.id_expediente;
              this.obtenerRequisitosExpediente(this.id_expediente, this.datosItem.categoriasId, this.datosItem.tiposInstrumentoId);
            } else {
              this.$refs.snackalert.SnackbarShow(
                "warning",
                "Alerta",
    ...
    //Crear/Asignar o Asignar el consultor al expediente
    async asignarConsultor(){
      this.btnAsignarConsultorLoading=true;
      await this.$store
          .dispatch(ASIGNAR_CONSULTOR_EXPEDIENTE, this.datosAsignacionConsultor)
          .then((res) => {
            if (res.status === 200) {
            ...
            this.btnAsignarConsultorLoading=false;
          })
          .catch(error => {
    ...
    async obtenerDatosItem(Id) {
      ...
      await this.$store
        .dispatch(OBTENER_CATEGORIA, Id)
        .then((res) => {
          //console.log(res);
          if (res.status === 200) {
            this.datosItem = this.$store.state.categorias.categoria;
            this.datosItem.estados_Id === 1
              ? (this.switchItemEstado = true)
    ...
    async obtenerRequisitosExpediente(expedienteId,categoriasId,tiposInstrumentoId){
      this.tableLoadingRequisitos=true;
      this.requisitosCargados = [];
      await this.$store
        .dispatch(OBTENER_REQUISITOS_EXPEDIENTE_BY_CATEGORIA_TIPOINSTRUMENTO, {categoriaId: categoriasId ,tipoInstrumentoId: tiposInstrumentoId, expedienteId: expedienteId})
        .then((res) => {
          //console.log(res);
          if (res.status === 200) {
            this.requisitosCargados = res.data;            
          } 
          this.tableLoadingRequisitos=false;
        })
        .catch(() => {
          this.$refs.snackalert.SnackbarShow("warning", "Alerta", `Ha ocurrido un error inesperado, por favor, póngase en contacto con el administrador del sistema.`);
          this.tableLoadingRequisitos=false;
    ...
    async cargarArchivo(){
        ...
        let path ='\\expedientes\\requisitos\\';
        this.btnCargaDocLoading=true;
        //this.datosArchivo={};
        ...
        .then((res) => {
            ...
            if(res.status===200){
                ...
                this.datosRequisitoExpediente.path = res.pathArchivo;
                this.registrarRequisitoExpediente();
            }
            else {
        ...
        .catch((error) => {
            ...
            this.btnCargaDocLoading=false;
            
        });
    },

    async registrarRequisitoExpediente(){
      this.datosRequisitoExpediente.expedienteId = this.id_expediente;
      await this.$store
          .dispatch(REGISTAR_REQUISITO_EXPEDIENTE, this.datosRequisitoExpediente)
          .then((res) => {
            //console.log(res);
            if (res.status === 200) {
              this.$refs.snackalert.SnackbarShow("success","Mensaje",res.message);
    ...
    mostrarModalCargaDocumento(documento, asigAcuerdoRequisitosId,  tipo) {
      tipo === 1
        ? (this.dialogCargaDocTitle = "Cargar requisito")
        : (this.dialogCargaDocTitle = "Cargar tdr");
      this.documentoSeleccionado = documento;
      this.dialogCargaDocumento = true;
      this.datosRequisitoExpediente.asigAcuerdoRequisitosId = asigAcuerdoRequisitosId;
    },
    ...
    obtenerDatosItemContacto(Id) {
      ...
      this.$store
        ...
        descargarArchivo(path){
            ...
            //console.log(newPath);
            window.open("http://localhost:5196"+ newPath, "_blank");
        },
  },
  created() {
    //this.obtenerItems();
