  ...
  <div>
    ...
    <!--div class="row">
      <div class="col col-md-12">
        <ComponenteEstadosExpediente></ComponenteEstadosExpediente>
      </div>
    </!--div-->
    <div class="row">
      <!--div class="col-xxl-4">
...
//import ComponenteEstadosExpediente from "@/view/pages/inicio/ComponenteEstadosExpediente.vue";
