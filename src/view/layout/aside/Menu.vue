<template>
  <ul class="menu-nav">
    ...
    <!--li class="menu-section">
      <h4 class="menu-text">Cooperacion Norte Sur (Externo UE)</h4>
    ...
    <li
      ...
      class="menu-item menu-item-submenu"
      v-bind:class="{
        'menu-item-open': hasActiveChildren('/cooperacion-norte-sur-externo')
      }"
      ...
      <!--div class="menu-submenu">
        ...
        <ul class="menu-subnav">
          <router-link
            to="/proyectos/cns/externo/registro-informacion"
            v-slot="{ href, navigate, isActive, isExactActive }"
            >
            <li
              aria-haspopup="true"
            ...
            >
              <a :href="href" class="menu-link" @click="navigate">
                ...
                <span class="menu-text">Registro de Información</span>
              </a>
            </li>
          </router-link>
        </ul>
    ...
    <!--li
      ...
      v-bind:class="{
        'menu-item-open': hasActiveChildren('/cooperacion-sur-sur')
      }"
    >
      <a href="#" class="menu-link menu-toggle">
        <i class="menu-icon flaticon2-digital-marketing"></i>
      ...
      <div class="menu-submenu">
        ...
        <ul class="menu-subnav">
          ...
          <router-link
            to="/administracion/proyectos/tradicionales"
            v-slot="{ href, navigate, isActive, isExactActive }"
          >
            <li
              aria-haspopup="true"
            ...
            >
              <a :href="href" class="menu-link" @click="navigate">
                ...
                <span class="menu-text">Programas/Proyectos</span>
              </a>
            </li>
          </router-link>
          <router-link
            to="/cooperacion-sur-sur/directa"
            v-slot="{ href, navigate, isActive, isExactActive }"
          >
            <li
              aria-haspopup="true"
            ...
            >
              <a :href="href" class="menu-link" @click="navigate">
                ...
                <span class="menu-text">Directa</span>
              </a>
            </li>
          </router-link>
        </ul>
    ...
    >
      <a href="#" class="menu-link menu-toggle">
        <i class="menu-icon flaticon2-digital-marketing"></i>
        <span class="menu-text">Negociaciones</span>
        <i class="menu-arrow"></i>
      </a>
      <div class="menu-submenu">
        <span class="menu-arrow"></span>
        <ul class="menu-subnav">
          ...
          <router-link
            to="/proyectos/css/externo/negociacion-comixta"
            v-slot="{ href, navigate, isActive, isExactActive }"
          >
            <li
              aria-haspopup="true"
            ...
            >
              <a :href="href" class="menu-link" @click="navigate">
                ...
                <span class="menu-text">Comixtas</span>
              </a>
            </li>
          </router-link>
          <router-link
            to="/proyectos/css/externo/negociacion-directa"
            v-slot="{ href, navigate, isActive, isExactActive }"
          >
            <li
              aria-haspopup="true"
    ...
    <!--li class="menu-section">
      <h4 class="menu-text">Cooperacion Sur - Sur (Interno DAD)</h4>
      <i class="menu-icon flaticon-more-v2"></i>
    </li-->
    ...
    <!--li
      ...
      class="menu-item menu-item-submenu"
      v-bind:class="{
        'menu-item-open': hasActiveChildren('/cooperacion-sur-sur-dad')
      }"
    >
      <a href="#" class="menu-link menu-toggle">
        <i class="menu-icon flaticon2-digital-marketing"></i>
      ...
      <div class="menu-submenu">
        ...
        <ul class="menu-subnav">
          ...
          <router-link
            to="/proyectos/css/dad/negociacion-comixta"
            v-slot="{ href, navigate, isActive, isExactActive }"
          >
            <li
              aria-haspopup="true"
          ...
          <router-link
            to="/proyectos/css/dad/negociacion-directa"
            v-slot="{ href, navigate, isActive, isExactActive }"
          >
            <li
              aria-haspopup="true"
